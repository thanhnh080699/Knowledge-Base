      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/dashboard/posts/create" className="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-[var(--foreground)] px-4 text-sm font-medium text-[var(--app-surface)] transition-colors hover:opacity-90">
                      ...
                      <TableCell className="pr-6 text-right">
                        <div className="flex items-center justify-end gap-2">
                          {trashed ? (
                            ...
                            <Link href={`/dashboard/posts/${post.id}`} className="inline-flex h-8 w-8 items-center justify-center rounded-md transition-colors hover:bg-[var(--app-surface-hover)]">
